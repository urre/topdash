...
Adds icons in the top right admin bar, easy access to common wp-admin menus

* [Github](https://github.com/urre/topdash)

== Installation ==

1. Upload the `topdash` folder to your `/wp-content/plugins/` directory
